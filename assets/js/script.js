...
document.addEventListener('DOMContentLoaded', () => {
   ...
   const currencies = {
       ...
       'BMD': { name: 'BMD Dollar', flag: 'bm.svg' },
       'BND': { name: 'Brunei Dollar', flag: 'bn.svg' },
       'BOB': { name: 'Boliviano', flag: 'bo.svg' },
       ...
       'HKD': { name: 'HKD Dollar', flag: 'hk.svg' },
       'HNL': { name: 'Lempira', flag: 'hn.svg' },
       'HTG': { name: 'Haitian Gourde', flag: 'ht.svg' },
       'HUF': { name: 'Hungarian Forint', flag: 'hu.svg' },
       'IDR': { name: 'Rupiah', flag: 'id.svg' },
       'ILS': { name: 'New Shekel', flag: 'il.svg' },
       'IMP': { name: 'IMP Pound', flag: 'im.svg' },
       ...
       'NOK': { name: 'NOK Krone', flag: 'no.svg' },
       ...
       'SRD': { name: 'SRD Dollar', flag: 'sr.svg' },
       ...
       'TWD': { name: 'TWD Dollar', flag: 'tw.svg' },
       'TZS': { name: 'Tanzanian Shilling', flag: 'tz.svg' },
       'UAH': { name: 'Hryvnia', flag: 'ua.svg' },
       ...
       'ZAR': { name: 'Rand', flag: 'za.svg' },
       'ZMW': { name: 'ZMW Kwacha', flag: 'zm.svg' },
       'ZWL': { name: 'ZWL Dollar', flag: 'zw.svg' },
   };
